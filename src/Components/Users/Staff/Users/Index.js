...
import { Spinner, Input, Tooltip } from "reactstrap";
...
export default class Index extends Component {
    ...
    userRecords = () => {
        ...
        axios
            .post(APIURL + "staff/user-list", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
                                                            ...
                                                            <tbody>
                                                                {
                                                                    this.state.userList.length > 0 && this.state.userList.map((user, index) =>
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td scope="row">{user.user_type === "Staff" ? <img style={{ height: "20px", width: "20px" }} src={StaffIcon} /> : user.user_type === "Admin" ? <img style={{ height: "20px", width: "20px" }} src={AdminIcon} /> : <img style={{ height: "20px", width: "20px" }} src={Guide} />}</td>
