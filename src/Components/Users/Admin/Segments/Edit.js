...
export default class Edit extends Component {
    ...
    editSegmentDetail = () => {
        ...
        axios
            .post(APIURL + "admin/edit-segment", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
    ...
    UpdateSegmentDetail = (e) => {
        ...
        this.setState({ Loader: true });
        axios
            .post(APIURL + "admin/update-segment", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
                                        ...
                                        <div className='page__wrapper-conten'>
                                            <div className='page__content page__content_pt64'>
                                                <div className='page__stat'>
                                                    <div className="page__title h4 mt-0 d-flex align-items-center"><Link className="back-btn" to="/admin/segments"><i className="fas fa-angle-left"></i></Link>  Edit Segment </div>
