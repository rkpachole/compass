...
export default class Add extends Component {
    ...
    submitHandle = (e) => {
        ...
        axios
            .post(APIURL + "admin/add-segment", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
    ...
    render() {
        if (this.state.redirect) {
            return <Redirect to="/admin/segments" />;
        }
        if (!this.state.user) {
            return <Redirect to="/" />;
        }
                                        ...
                                        <div className='page__wrapper-conten'>
                                            <div className='page__content page__content_pt64'>
                                                <div className='page__stat'>
                                                    <div className="page__title h4 mt-0 d-flex align-items-center"><Link className="back-btn" to="/admin/segments"><i className="fas fa-angle-left"></i></Link>Add Segment </div>
                                                    ...
                                                    <div className='profile-apge'>
                                                        <form noValidate className='' onSubmit={(e) => this.submitHandle(e)}>
                                                            <div className="row">
                                                                ...
                                                                <div className="mb-3 col-sm-6 col-12">
                                                                    <label htmlFor="exampleInputEmail1" className="field__label mb-3">Department <strong className="text-danger" > *</strong></label>
