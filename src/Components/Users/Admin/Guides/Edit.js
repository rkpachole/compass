...
export default class Add extends Component {
    ...
    UpdateGuide = (e) => {
        ...
        axios
            .post(APIURL + "admin/update-guide", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
    ...
    editGuideDetail = () => {
        ...
        this.setState({ isLoading: true });
        axios
            .post(APIURL + "admin/edit-guide", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
                                        ...
                                        <div className="page__wrapper-conten">
                                            <div className="page__content page__content_pt64">
                                                <div className="page__stat">
                                                    <div className="page__title h4 mt-0 d-flex align-items-center"><Link className="back-btn" to="/admin/guides"><i className="fas fa-angle-left"></i></Link> Edit Guide </div>
