...
export default class Index extends Component {
    ...
    deleteGuide = (status) => {
        ...
        axios
            .post(APIURL + "admin/update-guide-status", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
    ...
    guideList = () => {
        ...
        axios
            .post(APIURL + "admin/guide-list", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
                                                        ...
                                                        <table className="table responsiveTable">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th className="sort-by" scope="col" onClick={this.SortBy.bind(this, "start_date")} style={{ minWidth: "100px" }}>Start Date </th>
                                                                    <th className="sort-by" scope="col" onClick={this.SortBy.bind(this, "end_date")} style={{ minWidth: "100px" }}>End Date </th>
                                                                    ...
                                                                    this.state.guideList.length > 0 && this.state.guideList.map((guide, index) =>
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td data-label="Action" className='text-end'>
                                                                                <Link to={"/admin/edit/guide/" + guide.id} color='success' className='btn btn-sm me-1 btn-success'> <i className="fas fa-pen"></i> </Link>
