...
export default class Add extends Component {
    ...
    submitHandle = (e) => {
        ...
        this.setState({ Loader: true });
        axios
            .post(APIURL + "guide-manager/add-guide", formData, {
                headers: {
                    "Authorization": `Bearer ${token}`
                }
            })
                                        ...
                                        <div className='page__wrapper-conten'>
                                            <div className='page__content page__content_pt64'>
                                                <div className='page__stat'>
                                                    <div className="page__title h4 mt-0 d-flex align-items-center"><Link className="back-btn" to="/guide/guides"><i className="fas fa-angle-left"></i></Link> Guide List </div>
